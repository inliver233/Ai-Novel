...
from app.services import vector_rag_service, vector_storage
...
class TestVectorHybridRrf(unittest.TestCase):
    ...
    def test_overfiltering_relax_sources_then_expand_candidates(self) -> None:
        orig_is_postgres = vector_storage._is_postgres
        orig_fetch = vector_storage._pgvector_hybrid_fetch
        ...
        try:
            vector_storage._is_postgres = lambda: True  # type: ignore[assignment]
            vector_storage._pgvector_hybrid_fetch = _fake_fetch  # type: ignore[assignment]
            ...
            vector_storage._is_postgres = orig_is_postgres  # type: ignore[assignment]
            vector_storage._pgvector_hybrid_fetch = orig_fetch  # type: ignore[assignment]
